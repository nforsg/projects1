...
def plotter(time_array, array1, array2, array3, x_label, y_label, label1, label2, label3, title):
    ...
    plt.plot(time_array, array1, label = label1, color = 'blue' )
    plt.plot(time_array, array2, label = label2, color = 'purple')
    plt.plot(time_array, array3, label = label3, color = 'green')
    plt.xlabel(x_label)
    plt.ylabel(y_label)
    plt.legend()
    plt.show()
...
def timestep(screen, size1, size2, cells, size, p_energy, pred_p, omni_p, herba_p, energy_magnitude, n_p = 3, n_o = 3, n_h = 2, energy_decrease_m = 1, energy_decrease_n = 1, 
energy_increase_s = 1, m_o_omnivores = 3, m_p_o_predators = 1, m_p_h_predators = 1, m_o_h_omnivores = 2, with_progress = False):
...
def pygame_iterator(time_array, predators, omnivores, herbavores, pixels1, pixels2):
...
def main():
    ...
    pygame_iterator(time_array, predators, omnivores, herbavores, 1000, 1000)# 800, 600)
